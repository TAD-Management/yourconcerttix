...
.promo { display: flex; align-items: center; justify-content: space-between; gap: 16px; max-width: 1200px; margin: 0 auto 8px; padding: 16px 20px; border-radius: 16px;
  background: linear-gradient(90deg, rgba(233,69,96,.18), rgba(245,166,35,.14)); border: 1px solid rgba(245,166,35,.35); transition: transform .2s, box-shadow .2s; }
.promo:hover { transform: translateY(-2px); box-shadow: 0 16px 40px -16px rgba(233,69,96,.6); }
.promo .promo-text { display: flex; flex-direction: column; gap: 2px; }
...
/* Fundfare (school fundraising) banner, in the Fundfare flyer colours; links to the hand-built /fundfare/ page */
.promo.promo-fund { position: relative; gap: 18px; margin: 26px auto 8px; padding: 14px 20px 14px 16px; border: 0; color: #fff; background: repeating-conic-gradient(from 0deg at 80% 50%, #2250d9 0deg 7deg, #2c5ae3 7deg 14deg); }
.promo.promo-fund:hover { box-shadow: 0 16px 40px -16px rgba(34,80,217,.9); }
.promo-fund .promo-logo { flex: 0 0 auto; width: 130px; height: auto; transform: rotate(-3deg); }
.promo-fund .promo-text { flex: 1 1 auto; }
.promo-fund .promo-kicker { color: #e9ff3a; }
...
<a class="promo promo-fund" href="/fundfare/">
  <img class="promo-logo" src="/fundfare/img/fundfare-logo.webp" width="450" height="169" alt="Fundfare">
  <div class="promo-text">
    <span class="promo-kicker">School fundraising &middot; Schools, teams &amp; clubs</span>
    <span class="promo-title">Raise money for your school</span>
    <span class="promo-sub">$2 from every Apache Junction concert ticket bought through your school's link goes to your school or team.</span>
  </div>
  <img class="promo-bee" src="/fundfare/img/bee-sm.webp" width="240" height="235" alt="">
  <span class="promo-btn">Start Fundraising &rarr;</span>
</a>
<a class="promo" href="/gotphilvotedin/">
  <div class="promo-text">
    <span class="promo-kicker">Special event &middot; On sale now</span>
    <span class="promo-title">Got Phil Voted In</span>
    <span class="promo-sub">Four ticket packages. Pick yours before they're gone.</span>
  </div>
  <span class="promo-btn">See Packages &rarr;</span>
</a>
<div class="controls">
