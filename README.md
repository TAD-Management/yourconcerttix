...
- **`apachejunction/`** — standalone page for the Apache Junction Performing Arts Center, rebuilt by `scripts/apache-junction.mjs` from FanGenie's public API (no secrets needed). Every show links to its ticket page on FanGenie.
